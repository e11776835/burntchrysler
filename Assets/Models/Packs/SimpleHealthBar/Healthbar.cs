...
public class Healthbar : MonoBehaviour {
    ...
    [Tooltip("Minimum possible: (default is 0)")] public float minimumHealth = 0;

    // Maximum possible health:
    [Tooltip("Maximum possible: (default is 100)")] public float maximumHealth = 100;

    // If the character has this health or less, consider them having low health:
    [Tooltip("Low farts is less than or equal to this:")] public int lowHealth = 33;
    ...
    [Tooltip("High farts is greater than or equal to this:")] public int highHealth = 66;

    [Space]

    [Header("Regeneration:")]    
    // If 'regenerateHealth' is checked, character will regenerate health/sec at the rate of 'healthPerSecond':
    public bool regenerateFarts;
    public float fartsPerSecond;
    ...
    private void Update()
    {
        ...
        if (health < maximumHealth && regenerateFarts)
        {
            health += fartsPerSecond * Time.deltaTime;
    ...
    {
        regenerateFarts = !regenerateFarts;
    }
